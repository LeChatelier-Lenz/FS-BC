  ...
  <div class="modal">
    ...
    <div class="form">
      ...
      <form @submit.prevent="handleSubmit" class="sheet">
        ...
        <div class="input_container">
          <label for="is_sudden" class="input_label">是否突然事件</label>
          <select id="is_sudden" v-model="form.conditions.is_sudden" class="input_field" required>
            <option :value="true">是</option>
            <option :value="false">否</option>
          </select>
        </div>
        <div class="input_container">
          <label for="contingency_info" class="input_label">突发事件信息</label>
          <textarea id="contingency_info" v-model="form.conditions.contingency_info" class="input_field" rows="4" required></textarea>
        </div>
<!--        <div class="input_container">-->
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      axios.post('http://127.0.0.1:8001/ecosys/insurance/check_contract', this.form).then(
        response => {
